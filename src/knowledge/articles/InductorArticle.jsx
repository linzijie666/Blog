    ...
    <>
      ...
      <section id="circuits">
        ...
        <WorkedExample
          ...
          calculation={["占空比近似 D = 5V/12V = 0.417", "L = (12V - 5V) × 0.417/(0.9A × 400kHz) ≈ 8.1µH", "选择相邻标准值 8.2µH", "峰值电流 Ipeak = 3A + 0.9A/2 = 3.45A"]}
          verification={["建议 Isat 至少高于 4.1A，并核对厂商的感值下降判据", "Irms 需高于实际 RMS 电流并满足允许温升", "按 Irms² × DCR 计算铜损，再叠加磁芯损耗", "检查自谐振频率、屏蔽、尺寸和样机温度"]}
      ...
      <section id="interview">
        ...
        <div className="review-questions">
          ...
          <details><summary>DCR 如何影响效率？</summary><p>绕组铜损近似为 Irms² × DCR。DCR 还会造成直流压降和器件自身温升。</p></details>
